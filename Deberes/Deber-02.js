...
var ArregloPalabra = 'COMERCIO ELECTRÓNICO'

var ArregloPalabraInvertida = ''

var ArregloTamanoPalabra = ArregloPalabra.length

console.log(ArregloTamanoPalabra)

while (ArregloTamanoPalabra>=0) {
    ArregloPalabraInvertida = ArregloPalabraInvertida + ArregloPalabra.charAt(ArregloTamanoPalabra)
    ArregloTamanoPalabra--
...
console.log(ArregloPalabraInvertida)
...
function ArrayPrimeraPalabra(ArregloParrafo) {
    var pSeparado = ArregloParrafo.split(" ")
    var ArregloPrimeraPalabra = pSeparado[0]
    return ArregloPrimeraPalabra.toUpperCase()
}
...
function ArrayPalabradelMedio(ArregloParrafo) {
    var pSeparado = ArregloParrafo.split(" ")
    var ArregloTamanoArray = pSeparado.length
    var ArreglopalabradelMedio = ''
    if (ArregloTamanoArray % 2 == 0) {
        var ArreglonumMedio = ArregloTamanoArray/2
        ArreglopalabradelMedio = pSeparado[ArreglonumMedio -1] + " " + pSeparado[ArreglonumMedio]
    } else{
        var ArreglonumMedio = Math.trunc(ArregloTamanoArray/2)
        ArreglopalabradelMedio = pSeparado[ArreglonumMedio-1]
    }
    return ArreglopalabradelMedio.toUpperCase()
}
...
function ArrayUltimaPalabra(ArregloParrafo) {
    var pSeparado = ArregloParrafo.split(" ")
    var ArregloTamanoArray = pSeparado.length
    var ArregloUltimaPalabra = pSeparado[ArregloTamanoArray-1]
    return ArregloUltimaPalabra.toUpperCase()
}
...
function contadorPuntos(ArregloParrafo) {
    var pSeparado = ArregloParrafo.split(".")
    var ArregloTamanoArray = pSeparado.length
    return ArregloTamanoArray-1
}
...
function contadorComass(ArregloParrafo) {
    var pSeparado = ArregloParrafo.split(",")
    var ArregloTamanoArray = pSeparado.length
    return ArregloTamanoArray-1
}
